...
document.querySelector("#host-name").innerHTML = "Bemnet";
document.querySelector("#collaborator-name").innerHTML = "Danielle";
...
hidden.addEventListener("click", hideInstructions);
